...
export function InviteLanding({ inviteCode }: Props) {
  ...
  const registerHref = inviteCode ? `/register?ref=${encodeURIComponent(inviteCode)}` : '/register'
    ...
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] flex flex-col">
      ...
      <header className="flex items-center justify-between px-6 py-4 border-b border-[var(--border)]">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/login" className="text-sm text-[var(--text-muted)] hover:text-arc-blue transition-colors">
            {c.loginLink}
          </Link>
        </div>
      </header>
