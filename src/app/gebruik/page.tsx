...
export default function GebruikPage() {
  return (
    <LegalLayout title="Gebruiksvoorwaarden" lastUpdated="23 februari 2026">
      ...
      <ul>
        <li>
          <strong>Student:</strong> kan eigen stagegegevens aanmaken, raadplegen en bewerken.
          Heeft geen toegang tot gegevens van andere gebruikers.
        </li>
        <li>
          <strong>Docent:</strong> kan stagegegevens van studenten inzien. Heeft geen
          bewerkingsrechten op stagelogboeken van studenten.
        </li>
        <li>
