...
// Reconstructed changelog entries for every version since the project started.
// Items are written end-user-friendly in both NL and EN.
const HISTORY = [
  {
    version: '0.1.0',
    date: '2026-02-23',
...
export async function POST(req: Request) {
  ...
  // Optional: allow passing a secret key as an alternative auth method for CLI use
